...
this is a simple app to run Axe-Core accessibility tests using the streamlit.io cloud for learning purposes.
...
- The first dataframe will show the total of violations found.
- The second dataframe will show all the elements with issues.
...
# Streamlit Cloud
To work with streamlit.io we need to have the `packages.txt` file with the packages that the app is using,
